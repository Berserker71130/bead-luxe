    ...
    <div className="group relative flex flex-col bg-[#111111] border border-white/5 rounded-xl overflow-hidden transition-all duration-500 ease-out hover:-translate-y-2 hover:border-[#C9A84C]/40 hover:shadow-[0_20px_40px_rgba(201,168,76,0.15)]">
      <div className="relative aspect-[4/5] w-full overflow-hidden">
        ...
        <button
          ...
          className="absolute top-3 right-3 p-2 rounded-full bg-black/40 backdrop-blur-md border border-white/10 z-20 transition-all hover:scale-110"
        >
          <Heart
            size={18}
            className={
        ...
        <button
          ...
          className="absolute bottom-4 left-4 right-4 bg-[#FDFBF7] text-[#0A0A0A] py-2.5 rounded-lg font-semibold translate-y-12 opacity-0 transition-all duration-500 z-20 group-hover:translate-y-0 group-hover:opacity-100 hover:bg-[#C9A84C] hover:text-white"
        >
          Quick Add
        </button>
      </div>
      ...
      <div className="p-4 flex flex-col flex-grow relative z-10">
        ...
        <h3 className="text-[#FDFBF7] font-medium text-base mb-2 line-clamp-1 group-hover:text-[#C9A84C] transition-colors duration-300">
          {product.name}
        </h3>
