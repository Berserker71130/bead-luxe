  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        {/* Slide in panel */}
        <Dialog.Content className="fixed right-0 top-0 z-[120] h-full w-full max-w-md bg-[#0A0A0A] outline-none border-l border-white/10 p-0 shadow-2xl transition-transform duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right">
          ...
          <div className="flex h-full flex-col">
            ...
            {/* Footer / Summary */}
            {items.length > 0 && (
              <div className="border-t border-white/10 bg-white/[0.02] px-6 py-8 space-y4">
